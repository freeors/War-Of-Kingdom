...
#ifndef GUI_DIALOGS_SCROLL_SETTING_HPP_INCLUDED
#define GUI_DIALOGS_SCROLL_SETTING_HPP_INCLUDED
...
class tscroll_setting : public tsetting_dialog
{
public:
	explicit tscroll_setting(display& disp, const unit& u);
