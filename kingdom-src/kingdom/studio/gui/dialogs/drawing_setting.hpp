...
#ifndef GUI_DIALOGS_DRAWING_SETTING_HPP_INCLUDED
#define GUI_DIALOGS_DRAWING_SETTING_HPP_INCLUDED
...
class tdrawing_setting : public tsetting_dialog
{
public:
	explicit tdrawing_setting(display& disp, const unit& u);
