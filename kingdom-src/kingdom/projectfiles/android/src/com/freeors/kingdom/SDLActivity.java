...
public class SDLActivity extends Activity {
    ...
    // C functions we call
    public static native void nativeInit(String res_dir);
...
class SDLMain implements Runnable {
    public void run() {
        // Runs SDL_main()
    	String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/com.freeors.kingdom";
    	Log.v("SDL", path); 	
    	Log.v("SDL", "RUN");
