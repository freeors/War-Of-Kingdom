/* $Id: multiplayer_connect.hpp 47659 2010-11-21 13:59:20Z mordante $ */
/*
...
public:
	...
	public:
		...
		gui::combo combo_feature_;
		force_list_manager llm_;
	private:
	...
	connect(hero_map& heros, game_display& disp, gamemap& gmap, const config& game_config, chat& c,
