...
#ifndef GUI_WIDGETS_HEXMAP_HPP_INCLUDED
#define GUI_WIDGETS_HEXMAP_HPP_INCLUDED
...
public:
	...
	void set_callback_size_change(boost::function<void (thexmap*)> callback)
		{ callback_size_change_ = callback; }
private:
	...
	boost::function<void (thexmap*)> callback_size_change_;

	/** When we're used as a fixed size item, this holds the best size. */
	tpoint best_size_;

	/** When we're used as a keep size item, this holds the keep size. */
	tpoint keep_size_;
