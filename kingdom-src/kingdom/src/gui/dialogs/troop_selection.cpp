...
void ttroop_selection::hero_changed(twindow& window)
{
...
void ttroop_selection::fill_table(int catalog)
{
...
void ttroop_selection::catalog_page(twindow& window, int catalog, bool swap)
{
