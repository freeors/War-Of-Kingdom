...
void tside_report::pre_show(CVideo& /*video*/, twindow& window)
{
	...
	hero_table_->set_callback_value_change(dialog_callback<tside_report, &tside_report::city_changed>);
...
void tside_report::city_changed(twindow& window)
{
...
void tside_report::fill_table(int catalog)
{
...
bool tside_report::compare_row(tgrid& row1, tgrid& row2)
{
