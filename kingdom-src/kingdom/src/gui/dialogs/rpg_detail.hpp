...
#ifndef GUI_DIALOGS_RPG_DETAIL_HPP_INCLUDED
#define GUI_DIALOGS_RPG_DETAIL_HPP_INCLUDED
...
class trpg_detail : public tdialog
{
public:
	explicit trpg_detail(game_display& gui, std::vector<team>& teams, unit_map& units, hero_map& heros);
