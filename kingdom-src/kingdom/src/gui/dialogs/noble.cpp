...
void tnoble2::pre_show(CVideo& /*video*/, twindow& window)
{
	...
	treasure_list_->set_callback_value_change(dialog_callback<tnoble2, &tnoble2::treasure_selected>);
	human_list_->set_callback_value_change(dialog_callback<tnoble2, &tnoble2::human_selected>);
