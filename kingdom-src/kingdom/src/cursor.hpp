...
enum CURSOR_TYPE { NORMAL, WAIT, MOVE, ATTACK, BUILD, ENTER, ILLEGAL, STANDBY, HYPERLINK, MOVE_DRAG, ATTACK_DRAG, BUILD_DRAG, ENTER_DRAG, ILLEGAL_DRAG, STANDBY_DRAG, NO_CURSOR, NUM_CURSORS };
