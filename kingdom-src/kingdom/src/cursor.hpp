...
enum CURSOR_TYPE { NORMAL, WAIT, MOVE, ATTACK, TACTIC, BUILD, ENTER, ILLEGAL, STANDBY, HYPERLINK, 
	MOVE_DRAG, ATTACK_DRAG, TACTIC_DRAG, BUILD_DRAG, ENTER_DRAG, ILLEGAL_DRAG, STANDBY_DRAG, NO_CURSOR, NUM_CURSORS };
