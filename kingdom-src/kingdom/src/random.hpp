...
{
public:
	enum TYPE {UNGZIP = 1, START, TENT, INIT_SIDE, DO_COMMONER, END_TURN, INIT_AI, FRESH_HEROS, RECRUIT, EXPEDITE,
		DISBAND, BUILD, CAST_TACTIC, COUNTDOWN_UPDATE, MOVEMENT, ATTACK, RANDOM_NUMBER, CHOOSE, LABLE,
		RENAME, SPEAK, MOVE_HEROS, BELONG_TO, EVENT, CHECKSUM_CHECK, INCHING_BLOCK, CLEAR_LABELS, DIPLOMATISM,
		FINAL_BATTLE, INPUT, REFORM_CAPTAIN, ADD_CARD, ERASE_CARD, ARMORY, INTERIOR, ASSEMBLE_TREASURE, 
