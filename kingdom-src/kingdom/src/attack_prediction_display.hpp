/* $Id: attack_prediction_display.hpp 40489 2010-01-01 13:16:49Z mordante $ */
/*
...
private:
	...
	void get_hp_prob_vector(const double hp, std::vector<std::pair<int, double> >& hp_prob_vector);
