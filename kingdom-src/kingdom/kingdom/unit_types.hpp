...
namespace anim2 {
enum tapp_type {REINFORCE = MIN_APP_ANIM, INDIVIDUALITY, TACTIC, FORMATION_ATTACK, PERFECT,
	STRATAGEM_UP, STRATAGEM_DOWN, LOAD_SCENARIO, FLAGS, TEXT, PLACE, UPGRADE, CARD, PASS_SCENARIO, 
