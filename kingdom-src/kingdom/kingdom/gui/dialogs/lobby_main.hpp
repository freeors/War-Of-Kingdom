...
protected:
	...
	void adjust_game_row_contents(const game_info& game, int idx, twidget* grid);
...
private:
	...
	void gamelist_change_callback(twindow& window, tlistbox& list, const int type = twidget::drag_none);
