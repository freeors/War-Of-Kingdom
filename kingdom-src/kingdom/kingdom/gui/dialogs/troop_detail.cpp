...
void ttroop_detail::type_selected(twindow& window, tlistbox& list, const int type)
{
...
void ttroop_detail::pre_show(CVideo& /*video*/, twindow& window)
{
	...
	list->set_callback_value_change(dialog_callback3<ttroop_detail, tlistbox, &ttroop_detail::type_selected>);
