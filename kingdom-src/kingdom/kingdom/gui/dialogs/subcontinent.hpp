...
private:
	...
	void subcontinent_selected(twindow& window, tlistbox& list, const int type = twidget::drag_none);
	void city_selected(twindow& window, tlistbox& list, const int type = twidget::drag_none);
