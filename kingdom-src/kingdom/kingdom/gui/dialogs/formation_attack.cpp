...
void tformation_attack::unit_selected(twindow& window, tlistbox& list, const int type)
{
...
void tformation_attack::pre_show(CVideo& /*video*/, twindow& window)
{
	...
	tactic_list.set_callback_value_change(dialog_callback3<tformation_attack, tlistbox, &tformation_attack::unit_selected>);
	unit_selected(window, tactic_list);
}
