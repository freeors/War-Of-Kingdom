...
void tnoble_list::pre_show(CVideo& /*video*/, twindow& window)
{
	...
	treasure_list_->set_callback_value_change(dialog_callback3<tnoble_list, tlistbox, &tnoble_list::treasure_selected>);
...
void tnoble_list::treasure_selected(twindow& window, tlistbox& list, const int type)
{
	noble_list_index_ = treasure_list_->get_selected_row();
}
