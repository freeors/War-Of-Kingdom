...
void tselect_unit::type_selected(twindow& window, tlistbox& list, const int type)
{
...
void tselect_unit::pre_show(CVideo& /*video*/, twindow& window)
{
	...
	list->set_callback_value_change(dialog_callback3<tselect_unit, tlistbox, &tselect_unit::type_selected>);
