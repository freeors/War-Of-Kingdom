...
public:
	...
	twesnothd_lobby()
		: tlobby(new tlobby::tchat_sock(), new tlobby::thttp_sock(), new tlobby::ttransit_sock())
	{
...
SOCKET_STATE twesnothd_lobby::taccept_sock::receive_buf(textendable_buf& buf)
{
	...
	size_t len = SDLNet_Read32(reinterpret_cast<void*>(num_buf));
