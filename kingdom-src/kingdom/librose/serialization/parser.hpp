/* $Id: parser.hpp 46186 2010-09-01 21:12:38Z silene $ */
/*
...
void read(config &cfg, const std::string &in); 	// Throws config::error
void read_gz(config &cfg, std::istream &in);

void write(std::ostream &out, config const &cfg, unsigned int level=0, const std::string& def_textdomain = PACKAGE);
