...
#ifndef GUI_WIDGETS_THEME_HPP_INCLUDED
#define GUI_WIDGETS_THEME_HPP_INCLUDED
...
public:
	...
	void set_callback_size_change(boost::function<void (ttheme*)> callback)
...
private:
	...
	boost::function<void (ttheme*)> callback_size_change_;
