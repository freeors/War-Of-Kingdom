/* $Id: field.hpp 52533 2012-01-07 02:35:17Z shadowmaster $ */
/*
...
class tfield_text : public tfield<std::string, ttext_box, const std::string& >
{
public:
	tfield_text(const std::string& id,
		...
		tfield<std::string, ttext_box, const std::string& >
			(id, mandatory, callback_load_value, callback_save_value)
		{
		}
